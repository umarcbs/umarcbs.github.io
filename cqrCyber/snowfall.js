...
let _snowColor = "white"; /*color of snow flakes */
let _snowBg = "black"; /* background color*/
let _snowCount = 500; /* number of snow flakes */
let _snowMinRadius = 1; /*radius of snow flakes (size) */
let _snowMaxRadius = 5; /* */
let _snowMaxXVel = 0.5; /*movement of snow flakes (right and keft) */
let _snowMinYVel = 0.5; /* speed of back snow flakes*/
let _snowMaxYVel = 2; /*snow falling speed */
