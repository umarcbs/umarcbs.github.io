...
<style type="text/css">
	gr{
   	...
   	<h5 style="text-transform: capitalize; font-family: cursive;"><olow>cqr</olow><low>Cyber</low> <br>Query Form <i class="fa fa-thumb-tack "></i></h5><hr/>  
   	<p style="text-align: justify; line-height: 18px;">This simple tool will let you report errors to us incase you find any. Or for further queries, suggestions, or messages kindly send them to us by using this tool. We value your your comments and will be kept secure.
			<ul class="nav-list">
...
header("Location: queryform.php?msg= Your message has been sent successfully.");
exit();
}
?>
</script>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<script src="queryform.js" type="text/javascript"></script>
...
<input type="text" name="fromname"  placeholder="From Name" style="width: 100%; margin-top: 1px; background-color: rgba(169,169,169,0.2);">

<input type="text" name="fromemail"  placeholder="From Email" style="width: 100%; background-color: rgba(169,169,169,0.2);">
<!--
<input type="text" name="toemail" placeholder="To Email: soulatf3@gmail.com" style="width: 100%; background-color: rgba(169,169,169,0.2);">
-->
<input type="text" name="subject"  placeholder="Subject" style="width: 100%; background-color: rgba(169,169,169,0.2);">

<input type="text" name="textarea"  placeholder="Enter message" style="width: 100%;  background-color: rgba(169,169,169,0.2);">
<input type="submit" value="Send" name="Submit" style="background-color: darkorange; color: white; border-color: darkorange; font-size: 20px; font-family: cursive;">
<input type="reset"  name="Reset" value="Reset" style="background-color: darkorange; color: white; border-color: darkorange; font-size: 20px; font-family: cursive;">
<!--
...
<script>
<?php if (isset($_GET['msg'])) { echo "<font color=\"red\"><h3 align=\"left\"> $_GET[msg] </h3></font>"; } ?>
</script>
		   	...
		   	<div class="row">
		   		...
		   		<div class="col-seven tab-full social-links pull-right">
		  			...
		  			<div class="col-five tab-full bottom-links">
				   	...
				   	<div class="credits">
				   		<p style="color: silver;"><br><br>Designed and Coded by <a href="http://soulat.in" title="Umar Farooq">Umar Farooq</a>
